...
const ContactInfo = () => {
    ...
    return (
        <div className={`h-screen  sm:max-w-[350px] border-l border-black flex flex-col bg-black text-white fixed top-0 right-0 w-full transition-all ease-linear  duration-300 delay-150 ${contactInfo === true ? "-translate-x-0  z-20" : "translate-x-full"}`}>
